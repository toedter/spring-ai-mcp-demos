...
/**
 * Represents the active Server-Sent-Events stream for a single chat request.
 * The tool-approval wrapper uses it to push events (approval requests, status
 * updates) to the connected chatbot while the tool call is blocked.
 */
